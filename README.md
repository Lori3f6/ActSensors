...
| alt_vector_bypct  | factor multiply velocity             | `!=0`                      | Multiply player velocity by a float number. <br/> Values here expected are 1000 times scaled<br/>For example, 1000 stands for 1.0 in double                                                                                                                    |
